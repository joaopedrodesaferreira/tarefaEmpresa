...
class TelaAlterar():
    def __init__(self, window, idFuncionario):
        ...
        self.__window1.title('Alterar dados Funcionário')
        self.__window1.wm_protocol('WM_DELETE_WINDOW', self.fecharJanela)
        self.__window1.grab_set()
        ...
        self.__txtNome = tk.Entry(self.__frame2, textvariable=nome,font=('Arial', 8))
        ...
        self.__txtEndereco = tk.Entry(self.__frame2, textvariable=endereco,font=('Arial', 8))
        ...
        self.__txtEmail = tk.Entry(self.__frame2, textvariable=email,font=('Arial', 8))
        ...
        usuario.set(str(self.__loginDAO.login.nomeUsuario))
        ttk.Label(self.__frame4, text='Nome de Usuário', font=('Arial', 10)).grid(row=0, column=0, sticky=tk.W)
        self.__txtUsuario = tk.Entry(self.__frame4, textvariable=usuario, font=('Arial', 8))
        ...
        senha = tk.StringVar()
        senha.set(str(self.__loginDAO.login.senha))
        ttk.Label(self.__frame4, text='Senha', font=('Arial', 10)).grid(row=1, column=0, sticky=tk.W)
        self.__txtSenha = tk.Entry(self.__frame4, textvariable=senha,show='*', font=('Arial', 8))
